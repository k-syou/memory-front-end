    ...
    <div className="h-auto border-b border-solid border-black w-full box-border pt-[200px]">
      <Container variant={"main"} className='flex justify-center flex-col mx-auto items-center'>
        ...
        <div className='flex mt-10 mb-16 gap-[60px]'>
          <Button variant={'circleBtn'} className='h-[160px] w-[160px] justify-center flex'><CiMail className='my-auto h-16 w-16'/></Button>
          <Button variant={'circleBtn'} className='h-[160px] w-[160px] justify-center flex'><CiInstagram className='my-auto h-16 w-16'/></Button>
