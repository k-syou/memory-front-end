        ...
        <Container className="flex relative overflow-visible mt-20 mb-10 sm:flex-col sm:mt-[42px] sm:mb-4 sm:px-6">
          ...
          <div className="flex h-full absolute top-[60%] translate-y-[-50%] right-0 sm:relative sm:translate-y-0">
            <DropdownMenu
              ...
              valueId={valueId}
            />
            <input className="h-[46px] w-[320px] border box-border block pl-2 font-ko sm:text-b2 sm:w-full sm:h-10" />
            <Button variant={"searchBtn"} btnColor={"black"} className="text-b1 sm:text-b2 h-[46px] sm:h-10 border-l-0 text-gray100 hover:text-gray400 font-ko">검색</Button>
          </div>
        </Container>
      </Section>
    </>
