      ...
      <Container>
        <div className="table border-collapse border-b mb-8">
          ...
          {tableData.map((data, idx) => {
            return (
              <div
                key={idx}
                className={`table-row w-full ${idx != tableData.length-1 ? 'border-b border-gray500' : ''}`}
              >
        ...
        <div className="flex justify-end text-[25px] items-center mb-[72px]">
          ...
          <div className="flex gap-5 justify-center">
            <div className="w-[25px] h-[25px] rounded-full bg-black text-gray100 my-auto text-center"><Text className="text-h6 leading-[25px]">1</Text></div>
            <div><Text className="text-h6 text-gray500">2</Text></div>
            <div><Text className="text-h6 text-gray500">3</Text></div>
            <div><Text className="text-h6 text-gray500">4</Text></div>
            <div><Text className="text-h6 text-gray500">5</Text></div>
            <div><Text className="text-h6 text-gray500">6</Text></div>
            <div><Text className="text-h6 text-gray500">7</Text></div>
            <div><Text className="text-h6 text-gray500">8</Text></div>
            <div><Text className="text-h6 text-gray500">9</Text></div>
            <div><Text className="text-h6 text-gray500">10</Text></div>
          </div>
